...
void callback3(int bits, uint32_t value)
{	
	uint32_t facnum=0, cardnum=0, matchfound=0, raw_value=0;
	char * line = NULL;
	char * linex = NULL;
...
void callback4(int bits, uint32_t value)
{	
	uint32_t facnum=0, cardnum=0, matchfound=0, raw_value=0;
	char * line = NULL;
	char * linex = NULL;
...
/*
	...
	*/
	...
	printf("START READING TASK ");	
   	...
   	w2 = Pi_Wieg(READER2_0, READER2_1, callback2, 5);
   	w3 = Pi_Wieg(READER3_0, READER3_1, callback3, 5);
   	w4 = Pi_Wieg(READER4_0, READER4_1, callback4, 5);
	printf("[OK]\n");
